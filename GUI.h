...
//		Menu(Point xy, int w, int h, Kind kk, const string& s); //führt zu Problemen 
		Menu(Point xy, int w, int h, Kind kk, const string& s) : Widget(xy, w, h, s, 0), k(kk), offset(0){}	//die Lösung
